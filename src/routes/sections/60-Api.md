...
| onInput                  | `((color: { hsv: HsvaColor &#124; null; rgb: RgbaColor &#124; null; hex: string &#124; null; color: Colord &#124; null }) => void) |
| &#124; undefined`        |                                                                                                                                    | **event**<br/>listener, dispatch an event when the color changes |
| swatches                 | `string[]`                                                                                                                         | `[]`                                                             | **required**<br/>Optional array of color swatches to display below the picker                                                                                                                                |
